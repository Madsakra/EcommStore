...
public class AddUserFavouriteService implements Command<String, UserFavouriteDTO> {
    ...
    public AddUserFavouriteService(AccountRepository accountRepository, ProductRepository productRepository, GetUserFavouriteService getUserFavouriteService) {
    ...
    public UserFavouriteDTO execute(String id){
       ...
       // 5. Save the product to the account repository
        account.getFavouriteProducts().add(productTarget);
